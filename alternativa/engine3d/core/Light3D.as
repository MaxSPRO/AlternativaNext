...
package alternativa.engine3d.core {
	...
	public class Light3D extends Object3D {
		...
		public var shadowIntensity:Number = 1;
		
		public var excludeObject:Vector.<Object3D> = new Vector.<Object3D>();;
		...
		public function excludeIn(value:Object3D):void {
			if(excludeObject.indexOf(value)==-1)
			{
				excludeObject.push(value);
			}
		}
		
		public function excludeOut(value:Object3D):void {
			var index:int = excludeObject.indexOf(value)
			if(index>-1)
			{
				excludeObject.splice(index,1);
			}
		}
		
		public function exclude(value:Object3D):Boolean {
			if(excludeObject.indexOf(value)>-1)
			{
				return true;
			}
