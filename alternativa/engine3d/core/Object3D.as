...
package alternativa.engine3d.core {
	...
	public class Object3D implements IEventDispatcher {
		...
		/**
		 * Whether or not the display object is dynamik.
		 */		
		public var dynamik:Boolean = false;
		...
		//Max
		/**
		 * @public get Vector3D position coords
		 */		
		public function get posVector():Vector3D {
			return new Vector3D(_x, _y, _z);
		}

		/**
		 * @public set Vector3D position coords
		 */
		public function set posVector(value:Vector3D):void {
			//if (_z != value) {
				_x = value.x;
				_y = value.y;
				_z = value.z;
		...
		/**
		 *  @public get Vector3D scale
		 */
		public function get scaleXYZ():Number {
			return new Vector3D(_scaleX, _scaleY, _scaleZ).length;
		}

		/**
		 * @public set Vector3D scale
		 */
