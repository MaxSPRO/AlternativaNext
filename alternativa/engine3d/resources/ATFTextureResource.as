...
package alternativa.engine3d.resources {
	...
	public class ATFTextureResource extends TextureResource {
		...
		public function ATFTextureResource(data:ByteArray) {
			...
			if (data != null) {
				...
				switch (type & 0x7F) {
					...
					case 4:
					case 5:
						format = "compressedAlpha";//Context3DTextureFormat.COMPRESSED_ALPHA; // "compressedAlpha"Context3DTextureFormat.COMPRESSED_ALPHA
						break;
				}
			}
		}
		...
		public function uploadAsync(callback:Function, context3D:Context3D=null):void {
			if(context3D==null)
			{
				context3D=Helpers.CONTEXT;
			}
