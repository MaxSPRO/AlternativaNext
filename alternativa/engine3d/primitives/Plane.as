...
package alternativa.engine3d.primitives {
	...
	public class Plane extends Mesh {
		...
		public function resizeUV(size:int=1):void {

			var uvs:Vector.<Number> = this.geometry.getAttributeValues(VertexAttributes.TEXCOORDS[0]);  
		
			//trace("uvs = "+uvs); // 0,1,0,0,1,1,1,0,1,1,1,0,0,1,0,0  
		
			for (var i:int = 0; i < uvs.length; i=i+2) {      
			...
			this.geometry.setAttributeValues(VertexAttributes.TEXCOORDS[0], uvs); 
		}		
