package alternativa.physics.dynamics.character {
	import alternativa.physics.A3DBase;
	import alternativa.physics.collision.dispatch.A3DGhostObject;
	import alternativa.physics.collision.shapes.A3DCollisionShape;
	import alternativa.physics.math.A3DVector3;
	...
	*/
	...
	public class A3DKinematicCharacterController extends A3DBase {
		...
		public function A3DKinematicCharacterController(ghostObject : A3DGhostObject, stepHeight : Number) {
			m_ghostObject = ghostObject;

			pointer = bullet.createCharacterMethod(ghostObject.pointer, ghostObject.shape.pointer, stepHeight, 2);
