package alternativa.physics.dynamics {
	...
	import alternativa.physics.data.A3DCollisionFlags;
	import alternativa.physics.math.A3DMatrix3x3;
	import alternativa.physics.math.A3DVector3;
	import alternativa.physics.math.A3DMath;
	...
	public class A3DRigidBody extends A3DCollisionObject {
		...
		*/
		public function set mass(v : Number) : void {
			if (v == 0) {
				this.collisionFlags |= A3DCollisionFlags.CF_STATIC_OBJECT;
				inverseMass = 0;
			} else {
				this.collisionFlags &= (~A3DCollisionFlags.CF_STATIC_OBJECT);
				inverseMass = 1 / v;
